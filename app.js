...
class Metodo {
    ...
    div.innerHTML = `
      <div class="card text-center mb-4">
        <div class="card-body">
          ...
          <a href="#" class="btn btn-warning" name="editar"><i class="fas fa-pencil-alt"></i></a>
          <a href="#" class="btn btn-danger" name="borrar"><i class="fas fa-trash-alt"></i></a>
        </div>
      </div>
    `;
  ...
  guardarProductoLocalStorage(producto) {
    let productos;
    // Obtenemos los productos guardados en el localStorage
  ...
  obtenerProductosLocalStorage() {
    let productosLS;
    // Comprobamos si hay productos guardados en el localStorage
  ...
  // Cargar productos del localStorage al iniciar la aplicación
  cargarProductosLocalStorage() {
    let productosLS;
    productosLS = this.obtenerProductosLocalStorage();
    // Mostramos cada producto en la lista de productos
...
// Cargamos los productos del localStorage al iniciar la aplicación
const metodo = new Metodo();
metodo.cargarProductosLocalStorage();
